...
<div class="control-group" style="margin-bottom:5px;">
	...
	<div id="typeStartDiv">
		<div class="control-group"  style="margin-bottom:5px;">
			<label class="control-label">เลือกเดือนเริ่มต้น :</label>
			<div class="controls">
				<select class="span5" id="startMonth">
	...
	<div id="typeEndDiv">
		<div class="control-group"  style="margin-bottom:5px;">
			<label class="control-label">เลือกเดือนสิ้นสุดต้น :</label>
			<div class="controls">
				<select class="span5" id="endMonth">
					<option value="0">ตุลาคม</option>
					<option value="1">พฤศจิกายน</option>
					<option value="2">ธันวาคม</option>
					<option value="3">มกราคม</option>
...
<script src="<c:url value='/resources/js/pages/m81r06.js'/>"></script>
