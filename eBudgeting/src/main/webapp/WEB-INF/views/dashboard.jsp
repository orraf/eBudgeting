...
var menuJson = [{
	...
	menus: [{
		name: "ข้อมูลพื้นฐานงบประมาณ(m11)", code: "m11", parent: 'm1', menus: [{
			name: "m1f05: เพิ่มข้อมูลเริ่มต้นปีงบประมาณ", code:"m1f05", parent: 'm11', link: "page/m1f05/", group: ["PMS_BGT_ADMIN", "PMS_BGT"]
		}]
	}]
},{
	...
	menus: [{
		name: "ทะเบียนสายยุทธศาสตร์การจัดสรรงบประมาณ (m51)", parent: 'm5' ,code: "m51", menus: [{
			name: "m51f01: (1) ทะเบียนแผนงาน", code: "m51f01", parent: 'm51' , link: "page/m51f01/", group: ["PMS_BGT_ADMIN", "PMS_BGT"]
		},{
			name: "m51f02: (2) ทะเบียนยุทธศาสตร์", code: "m51f02", parent: 'm51', link: "page/m51f02/", group: ["PMS_BGT_ADMIN", "PMS_BGT"]
		},{
			name: "m51f03: (3) ทะเบียนผลผลิต/โครงการ", code: "m51f03", parent: 'm51', link: "page/m51f03/", group: ["PMS_BGT_ADMIN", "PMS_BGT"]
		},{	
			name: "m51f04: (4) ทะเบียนกิจกรรมหลัก", code: "m51f04", parent: 'm51', link: "page/m51f04/", group: ["PMS_BGT_ADMIN", "PMS_BGT"]
		},{
			name: "m51f05: (5) ทะเบียนแผนปฏิบัติการ", code: "m51f05", parent: 'm51', link: "page/m51f05/", group: ["PMS_BGT_ADMIN", "PMS_BGT"]
		},{
			name: "m51f06: (6) ทะเบียนกิจกรรมรอง", code: "m51f06", parent: 'm51', link: "page/m51f06/", group: ["PMS_BGT_ADMIN", "PMS_BGT"]
		},{
			name: "m51f18: ทะเบียนหน่วยนับ", code: "m51f18", parent: 'm51', link: "page/m51f18/", group: ["PMS_BGT_ADMIN", "PMS_BGT"]
		}
	]},{
		name: "ทะเบียนรายการงบลงทุน (m52)", code: "m52", parent: 'm5', menus: [{
			name: "m52f01: ทะเบียนรายการงบลงทุน", code: "m52f01", parent: 'm52', link: "page/m52f01/", group: ["PMS_BGT_ADMIN", "PMS_INV"]
		}, {
			name: "m52f02: ทะเบียนประเภทงบลงทุน", code: "m52f02", parent: 'm52', link: "page/m52f02/", group: ["PMS_BGT_ADMIN", "PMS_INV"]
		}]
	}]
},{
	...
	menus: [{
		name: "การจัดสรรงบประมาณ (m71)",code: "m71", parent: 'm7',  menus:[{
			name: "m71f01: บันทึกการจัดสรรงบประมาณ", code: "m71f01", parent: 'm71', link: "page/m71f01/", group: ["PMS_BGT_ADMIN", "PMS_BGT", "PMS_INV"]
		}]  
	},{
	...
	menus: [{
		name: "รายงานทะเบียน (m81r)", code: "m81r", parent: 'mr', menus: [{
	    	...
	    	name: "m81r12: รายงานแผนปฏิบัติการสำหรับเจ้าของกิจกรรม", code: "m81r12", parent: 'm81r', link: "m81r12.xls/"+fiscalYear+"/file/m81r12.xls", type: "download",  group: ["PMS_PLAN", "PMS_USER", "PMS_USER1", "PMS_USER2"]
	    },{
	    	name: "m81r02: รายงานแผนปฏิบัติการสำหรับส่วนงาน/กยท ข./กยท.จ./กยท.ส.", code: "m81r02", parent: 'm81r', link: "page/m81r02/",  group: ["PMS_PLAN", "PMS_USER", "PMS_USER1", "PMS_USER2", "PMS_USER3", "PMS_USER4"]
	    },{
