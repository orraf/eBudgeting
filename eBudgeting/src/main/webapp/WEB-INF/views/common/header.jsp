	...
	<div class="span12" id="pageHeader">
		 	...
		 	<div class="container" style="margin-top: 85px;">
				...
				<p class="navbar-text pull-right" style="color: #FFFFFF;">
					...
					Logged in as
						 <sec:authentication property="principal.username"/> (<sec:authentication property="principal.person.firstName"/>  <sec:authentication property="principal.person.lastName"/>) @ <sec:authentication property="principal.workAt.abbr"/> <c:if test="${isSubSection == true}"><sec:authentication property="principal.workAt.parent.abbr"/></c:if> | <a class="navbar-link" href="<c:url value='/logout'/>">Logout</a>
				</p>
				</div>
