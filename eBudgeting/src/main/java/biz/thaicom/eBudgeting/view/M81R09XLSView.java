...
public class M81R09XLSView extends AbstractPOIExcelView {
	...
	protected void buildExcelDocument(Map<String, Object> model,
		...
		ResultSet rs = st.executeQuery("select t6.code, t6.abbr, ' ' seq, t2.code, t2.description, t1.quantity, t1.unitbudget, t1.quantity * t1.unitbudget total, t5.assetgroupcode, t4.assettypecode, t3.assetkindcode, t7.name categoryName, t8.code, t8.abbr " +
									   "from bgt_assetallocation t1, bgt_assetbudget t2, gla_assetkind t3, gla_assettype t4, gla_assetgroup t5, hrx_organization t6, bgt_assetcategory t7, hrx_organization t8 " +
		...
		while (rs.next()) {
			...
			if (code.equals(rs.getString(13))) rsc0.setCellValue(" ");
				...
				rsc0.setCellValue(rs.getString(14));
