...
//		cell31.setCellStyle(styles.get("header"));
		...
		ResultSet rs = st.executeQuery(""
				...
				+ " t1.quantity,"							// 6
				+ " t1.unitbudget,"							// 7
				+ " t1.quantity * t1.unitbudget total,"		// 8
				+ " t5.assetgroupcode,"						// 9
				+ " t4.assettypecode,"						// 10
				+ " t3.assetkindcode,"						// 11
				+ " t7.name categoryName, " 					// 12
				+ " t8.abbr parent_abbr "					// 13  
				+"FROM  bgt_assetallocation t1, bgt_assetbudget t2, gla_assetkind t3, gla_assettype t4, gla_assetgroup t5,"
				+ " hrx_organization t6,  bgt_assetcategory t7, hrx_organization t8 "
